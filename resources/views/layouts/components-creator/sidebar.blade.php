        ...
        <div class="d-flex justify-content-between align-items-center">
            <div class="logo">
                <a href="{{ url('/') }}" class="d-flex align-items-center text-decoration-none">
                    <img src="{{ asset('assets/compiled/jpg/VreatorLogo1.png') }}"
                        alt="Vreator Logo"
                        style="height:40px;"
                        >reator
                </a>
...
<div class="sidebar-menu">
    <ul class="menu">
        ...
        <li class="sidebar-item {{ request()->routeIs(auth()->user()->role.'.dashboard') ? 'active' : '' }}">
            <a href="{{ route(auth()->user()->role.'.dashboard') }}" class="sidebar-link">
        ...
        @if(auth()->user()->role === 'creator')
            <li class="sidebar-title">Creator</li>
            ...
            <li class="sidebar-item {{ request()->routeIs('creator.template.*') ? 'active' : '' }}">
                <a href="{{ route('creator.template.index') }}" class="sidebar-link">
